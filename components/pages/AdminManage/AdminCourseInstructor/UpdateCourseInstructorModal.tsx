...
export default function UpdateCourseInstructorModal({
    ...
    /* ===== STATE ===== */
    const [form, setForm] =
        useState<UpdateCourseInstructorPayload>({
            course_id: "",
            user_id: "",
        ...
        >
            ...
            <div className="grid grid-cols-[140px_1fr] items-center gap-3">
                ...
                <input
                    disabled
                    value={courseLabel}
                    className="input-admin text-white/60 cursor-not-allowed border border-white/40 rounded-md"
                />
            </div>
