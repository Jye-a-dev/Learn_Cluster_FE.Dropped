    ...
    >
      ...
      >
        ...
        <div className="bg-cyan-200 rounded-lg p-4 text-sm text-emerald-600 mb-6">
          Sau khi đăng nhập, bạn có thể tải tài liệu bài tập, thực hiện
          yêu cầu và nộp bài trước thời hạn. Việc hoàn thành bài tập giúp
          bạn củng cố kiến thức và đánh giá mức độ hiểu bài của mình.
        </div>
