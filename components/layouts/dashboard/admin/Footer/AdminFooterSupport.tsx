...
import { SUPPORT_LINKS } from "./FooterData";

export default function UserFooterSupport() {
    return (
        <div className="rounded-xl bg-white/10 backdrop-blur-sm p-4 pb-[12%] shadow-sm border-white border-2">
