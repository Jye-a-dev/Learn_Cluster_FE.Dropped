...
import { USER_NAV_LINKS, USER_NAV_DROPDOWNS } from "@/components/layouts/dashboard/user/Navbar/UserNavData";
...
export default function UserNavbar() {
  ...
  return (
    <header className="z-9999 bg-linear-to-r from-emerald-800 to-lime-500 text-white shadow-lg rounded-2xl border-2 border-white">
